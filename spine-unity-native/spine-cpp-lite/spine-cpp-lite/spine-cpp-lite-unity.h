...
//spine bonedata
SPINE_CPP_LITE_EXPORT intptr_t spine_bonedata_get_Handle_x_unity(intptr_t skeletondataHandle, int index);
SPINE_CPP_LITE_EXPORT void spine_bonedata_set_length_unity(intptr_t boneDataHandle, float newLength);
SPINE_CPP_LITE_EXPORT float spine_bonedata_get_length_unity(intptr_t boneDataHandle);
SPINE_CPP_LITE_EXPORT void spine_bonedata_set_x_unity(intptr_t boneDataHandle, float newX);
SPINE_CPP_LITE_EXPORT float spine_bonedata_get_x_unity(intptr_t boneDataHandle);
SPINE_CPP_LITE_EXPORT void spine_bonedata_set_y_unity(intptr_t boneDataHandle, float newY);
SPINE_CPP_LITE_EXPORT float spine_bonedata_get_y_unity(intptr_t boneDataHandle);
SPINE_CPP_LITE_EXPORT void spine_bonedata_set_rotation_unity(intptr_t boneDataHandle, float newRotation);
SPINE_CPP_LITE_EXPORT float spine_bonedata_get_rotation_unity(intptr_t boneDataHandle);
SPINE_CPP_LITE_EXPORT void spine_bonedata_set_scaleX_unity(intptr_t boneDataHandle, float newScaleX);
SPINE_CPP_LITE_EXPORT float spine_bonedata_get_scaleX_unity(intptr_t boneDataHandle);
SPINE_CPP_LITE_EXPORT void spine_bonedata_set_scaleY_unity(intptr_t boneDataHandle, float newScaleY);
SPINE_CPP_LITE_EXPORT float spine_bonedata_get_scaleY_unity(intptr_t boneDataHandle);
SPINE_CPP_LITE_EXPORT void spine_bonedata_set_shearX_unity(intptr_t boneDataHandle, float newShearX);
SPINE_CPP_LITE_EXPORT float spine_bonedata_get_shearX_unity(intptr_t boneDataHandle);
SPINE_CPP_LITE_EXPORT void spine_bonedata_set_shearY_unity(intptr_t boneDataHandle, float newShearY);
SPINE_CPP_LITE_EXPORT float spine_bonedata_get_shearY_unity(intptr_t boneDataHandle);
SPINE_CPP_LITE_EXPORT void spine_bonedata_set_skinRequired_unity(intptr_t boneDataHandle, bool newSkinRequired);
SPINE_CPP_LITE_EXPORT bool spine_bonedata_get_skinRequired_unity(intptr_t boneDataHandle);
SPINE_CPP_LITE_EXPORT int spine_bonedata_get_transformMode_unity(intptr_t boneDataHandle);
SPINE_CPP_LITE_EXPORT void spine_bonedata_set_transformMode_unity(intptr_t boneDataHandle, int transformMode);
SPINE_CPP_LITE_EXPORT const char* spine_bonedata_get_data_name_unity(intptr_t boneDataHandle);
SPINE_CPP_LITE_EXPORT intptr_t spine_bonedata_create_unity(int index, const char* name);
SPINE_CPP_LITE_EXPORT int spine_bonedata_get_index_unity(intptr_t boneDataHandle);
#endif